...
from grpc_auth_service.oauth_service_pb2_grpc import YandexOAuthServicer
...
class YandexOAuthController(BaseController, YandexOAuthServicer):
    def __init__(self, cache: Any, session_maker: Any):
        super().__init__(cache, session_maker)
        self.oauth_service = YandexOAuthService(cache=self.cache, session_maker=self.session_maker)
