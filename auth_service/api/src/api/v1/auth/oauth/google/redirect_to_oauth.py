...
REDIRECT_ENDPOINT = ".google_oauth_login"


class GoogleOAuthUrlRedirectView(SwaggerView):
    decorators = [
        extract_connect_info,
    ]
    summary = "OAuth"
    description = "Redirect to the Google OAuth 2.0 authentication page"
    tags = ["oauth"]
    ...
    def get(self, connect_info: ConnectionInfo) -> Response:
        """
        Redirect to Google OAuth 2.0 for authentication.
        ---
        """
